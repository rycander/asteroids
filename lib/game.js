(function () {
  ...
  Game.prototype.collide = function () {
    for(var i = 0; i < this.asteroids.length; ++i) {
      ...
      if (this.ship.firing &&
        this.asteroids[i].isCollidedWithRay(
          this.ship.laserStart,
          this.ship.laserEnd
        ) ||
        this.asteroids[i].isCollidedWithRay(
          Util.addVec(this.ship.laserStart, this.ship.vecNorm),
          Util.addVec(this.ship.laserEnd, this.ship.vecNorm)
        ) ||
        this.asteroids[i].isCollidedWithRay(
          Util.subVec(this.ship.laserStart, this.ship.vecNorm),
          Util.subVec(this.ship.laserEnd, this.ship.vecNorm)
        )) {
