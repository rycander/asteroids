  ...
  Game.prototype.collide = function () {
    for(var i = 0; i < this.asteroids.length; ++i) {
      ...
      if (this.ship.firing && (
        ...
        this.asteroids[i].isCollidedWithRay(
          Util.vecAdd(this.ship.laserStart, this.ship.vecNorm),
          Util.vecAdd(this.ship.laserEnd, this.ship.vecNorm)
        ) ||
        this.asteroids[i].isCollidedWithRay(
          Util.vecSub(this.ship.laserStart, this.ship.vecNorm),
          Util.vecSub(this.ship.laserEnd, this.ship.vecNorm)
        ))) {
